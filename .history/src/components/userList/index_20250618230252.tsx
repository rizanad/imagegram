...
interface UserListProps {
  onFollowUpdate?: () => void; // Callback to refresh profile data
}

const UserList = ({ onFollowUpdate }: UserListProps) => {
  ...
  const handleFollow = async (targetUserId: string) => {
    ...
    try {
      ...
      // Find the user being followed to get their name
      const userBeingFollowed = users.find((u) => u.uid === targetUserId);
      const userName = userBeingFollowed?.displayName || "User";
      ...
      // Show success toast with the user's name
