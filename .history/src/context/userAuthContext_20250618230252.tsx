...
const googleSignIn = async () => {
  ...
  console.log("Google user:", user.uid, user.email, user.displayName);
  ...
  console.log("Saving Google user to Firestore:", userData);

  await setDoc(doc(db, "users", user.uid), userData);

  console.log("Google user saved to Firestore successfully");
